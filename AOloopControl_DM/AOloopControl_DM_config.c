...
errno_t AOloopControl_printDMconf()
{
    ...
    printf("DM | on |  x |  y | Nbch | busy | ave | DClevel | monint  | stat | "
    ...
    for (DMindex = 0; DMindex < NB_DMindex; DMindex++)
        {
            ...
            printf("%02ld |  %1d |%3u |%3u |  %02ld  |   %1d  |  %1d  | %6.2f  "
                   "|%8ld |   %02d |   %3ld  |    %4d  |    "
                   "%4d "
                   " | %9.2f |   %3s  |  %6s | %11s |\n",
                   DMindex,
