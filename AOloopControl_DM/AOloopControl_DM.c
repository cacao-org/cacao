...
errno_t AOloopControl_DM_CombineChannels_cli()
{
    ...
    // 11 char *wfsref_out
    // 12 int voltmode
    // 13 int volttype     : voltage command type (1: linear bipolar, output is
    // float) (2: quadratic unipolar, output is UI16) 14 float stroke100  :
    // displacement [um] for 100 V 15 char *IDvolt_name 16 float DCum 17 float
    // maxvolt
    ...
    //     AOloopControl_DM_CombineChannels(0, 50, 50, 12, 1, 0, "dmmodes",
    //     "outdisp", 0, "wfsrm", "refout", 1, 2, 0.7, "dmvolt", 0.0, 150.0);
    // }
}
    ...
    if (CLI_checkarg(1, 2) + CLI_checkarg(3, 2) + CLI_checkarg(3, 2) == 0)
        {
            AOloopControl_DM_dmturb(
                data.cmdargtoken[1].val.numl, 1, data.cmdargtoken[2].val.string, data.cmdargtoken[3].val.numl);
            return CLICMD_SUCCESS;
        }
    else
        {
...
static errno_t init_module_CLI()
{
   ...
   */
    ...
    RegisterCLIcommand("aolcontrolDMcomb",
                       __FILE__,
                       AOloopControl_DM_CombineChannels_cli,
                       "create and combine DM channels",
                       "<DMindex (0-9)> <xsize> <ysize> <NBchannel> <AveMode (1=if average "
                       "level removed)> <dm2dm "
                       "mode> <DMmodes> <outdm stream> <wfsref mode> <WFS resp mat> <wfsref "
                       "stream> <voltmode "
                       "(1=dmvolt computed)> <dmvolttype> <dmstroke100> <dmvoltname> "
                       "<DClevel> <maxvolt [V]>",
                       "aoloopcontrolDMcomb 0 50 50 8 0 1 dmmodes outdm 1 wfsrm wfsrefout 1 1 "
                       "1.0 dmvolt 0.78 120.0",
                       "int AOloopControl_DM_CombineChannels(long DMindex, long xsize, long "
                       "ysize, int NBchannel, int "
                       "AveMode, int dm2dm_mode, const char *dm2dm_DMmodes, const char "
                       "*dm2dm_outdisp, int wfsrefmode, "
                       "const char *wfsref_WFSRespMat, const char *wfsref_out, int voltmode, "
                       "int volttype, float "
                       "stroke100,const char *IDvolt_name, float DClevel, float maxvolt)");

    RegisterCLIcommand("aoloopcontroldmcomboff",
                       __FILE__,
    ...
    RegisterCLIcommand("aoloopcontroldmtrigoff",
                       __FILE__,
   ...
   */
    ...
    RegisterCLIcommand("aolcontroldmchgain",
                       __FILE__,
    ...
    RegisterCLIcommand("aoldmvoltON",
                       __FILE__,
    ...
    RegisterCLIcommand("aoldmvoltOFF",
                       __FILE__,
    ...
    RegisterCLIcommand("aolsetdmvoltmax",
                       __FILE__,
    ...
    RegisterCLIcommand("aolsetdmAveM",
                       __FILE__,
    ...
    RegisterCLIcommand("aolsetdmTrigMode",
                       __FILE__,
    ...
    RegisterCLIcommand("aolsetdmTrigChan",
                       __FILE__,
    ...
    RegisterCLIcommand("aolsetdmTrigSem",
                       __FILE__,
   ...
   */
    ...
    RegisterCLIcommand("aoloopcontroldmturb",
                       __FILE__,
                       AOloopControl_DM_dmturb_cli,
                       "DM turbulence",
                       "<DMindex (0-9)>",
                       "aoloopcontroldmturb 0",
                       "int AOloopControl_DM_dmturb(long DMindex, int mode, "
                       "const char *IDout_name, long NBsamples)");

    RegisterCLIcommand("aoloopcontroldmturb2im",
                       __FILE__,
    ...
    RegisterCLIcommand("aoloopcontroldmturboff",
                       __FILE__,
    ...
    RegisterCLIcommand("aoloopcontroldmturws",
                       __FILE__,
    ...
    RegisterCLIcommand("aoloopcontroldmturampl",
                       __FILE__,
    ...
    RegisterCLIcommand("aoloopcontroldmturlo",
                       __FILE__,
    ...
    RegisterCLIcommand("aoloopcontroldmturtint",
                       __FILE__,
   ...
   */
    ...
    RegisterCLIcommand("aoloopcontroldmmkttcirc",
                       ...
                       "long DMindex, long NBpts, float ampl)");

    RegisterCLIcommand("aoloopcontroldmastrogseq",
                       __FILE__,
                       ...
                       "long AOloopControl_DM_mkAstroGrid_seq(char *IDoutname, long DMindex, "
                       "int XYmode, int bin, long NBcycle)");
