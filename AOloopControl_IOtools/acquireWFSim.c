                            ...
                            for (uint64_t ii = 0; ii < sizeWFS; ii++)
                                {
                                    data.image[ID_imWFS0].array.F[ii] =
                                        ((float)arrayutmp[ii]) - data.image[IDwfsdark].array.F[ii];
                                }
                        }
                    break;
                    ...
                    if (IDwfsdark == -1)
                    ...
                    else
                        {
                            for (uint64_t ii = 0; ii < sizeWFS; ii++)
                                {
                                    data.image[ID_imWFS0].array.F[ii] =
                                        ((float)arraystmp[ii]) - data.image[IDwfsdark].array.F[ii];
                                }
                        }
                    break;
            ...
            for (uint64_t ii = 0; ii < sizeWFS; ii++)
                {
                    data.image[ID_imWFS3].array.F[ii] =
                        tave_mult * ((1.0 - tave_gain) * data.image[ID_imWFS3].array.F[ii] +
