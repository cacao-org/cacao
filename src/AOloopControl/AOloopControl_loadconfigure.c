 ...
 */
errno_t AOloopControl_loadconfigure(
    long loop,
    int  mode,
    int  level
)
...
//    sprintf(commentstring, "loop=%ld mode=%d level=%d", loop, mode, level);
    ...
    AOconf[loop].WFSim.WFSnormalize = AOloopControl_readParam_int("WFSnorm", 1,
                                      fplog);
    ...
    AOconf[loop].AOtiminginfo.loopfrequ = AOloopControl_readParam_float("loopfrequ",
                                          1000.0, fplog);
    AOconf[loop].AOtiminginfo.hardwlatency =
        AOloopControl_readParam_float("hardwlatency", 0.0, fplog);
    ...
    AOconf[loop].AOtiminginfo.complatency =
        AOloopControl_readParam_float("complatency", 0.0, fplog);
    AOconf[loop].AOtiminginfo.complatency_frame =
        AOconf[loop].AOtiminginfo.complatency * AOconf[loop].AOtiminginfo.loopfrequ;

    AOconf[loop].AOtiminginfo.wfsmextrlatency =
        AOloopControl_readParam_float("wfsmextrlatency", 0.0, fplog);
    ...
    AOconf[loop].AOcompute.GPUall = AOloopControl_readParam_int("GPUall", 0,
                                    fplog); // Skip CPU image scaling and go straight to GPUs ?
    AOconf[loop].aorun.DMprimaryWriteON =
        AOloopControl_readParam_int("DMprimaryWriteON", 0,
                                    fplog);    // Direct DM write ?
    AOconf[loop].aorun.DMfilteredWriteON =
        AOloopControl_readParam_int("DMfilteredWriteON", 0,
    ...
    AOconf[loop].AOcompute.AOLCOMPUTE_TOTAL_ASYNC =
        AOloopControl_readParam_int("COMPUTE_TOTAL_ASYNC", 1, fplog);
    ...
    AOconf[loop].RTLOGsize  = AOloopControl_readParam_int("RTLOGsize", 30000,
                              fplog);

    /// By default, LOG is enabled
    AOconf[loop].RTSLOGarray[RTSLOGindex_wfsim].ENABLE
        = AOloopControl_readParam_int("RTstreamLOG_wfsim_ENABLE",                1,
                                      fplog);
    AOconf[loop].RTSLOGarray[RTSLOGindex_wfsim].ON
        = AOloopControl_readParam_int("RTstreamLOG_wfsim_ON",                    1,
                                      fplog);
    AOconf[loop].RTSLOGarray[RTSLOGindex_wfsim].save
        = AOloopControl_readParam_int("RTstreamLOG_wfsim_save",                  0,
                                      fplog);

    AOconf[loop].RTSLOGarray[RTSLOGindex_imWFS0].ENABLE
        = AOloopControl_readParam_int("RTstreamLOG_imWFS0_ENABLE",               1,
                                      fplog);
    AOconf[loop].RTSLOGarray[RTSLOGindex_imWFS0].ON
        = AOloopControl_readParam_int("RTstreamLOG_imWFS0_ON",                   1,
                                      fplog);
    AOconf[loop].RTSLOGarray[RTSLOGindex_imWFS0].save
        = AOloopControl_readParam_int("RTstreamLOG_imWFS0_save",                 0,
                                      fplog);

    AOconf[loop].RTSLOGarray[RTSLOGindex_imWFS1].ENABLE
        = AOloopControl_readParam_int("RTstreamLOG_imWFS1_ENABLE",               1,
                                      fplog);
    AOconf[loop].RTSLOGarray[RTSLOGindex_imWFS1].ON
        = AOloopControl_readParam_int("RTstreamLOG_imWFS1_ON",                   1,
                                      fplog);
    AOconf[loop].RTSLOGarray[RTSLOGindex_imWFS1].save
        = AOloopControl_readParam_int("RTstreamLOG_imWFS1_save",                 0,
                                      fplog);

    AOconf[loop].RTSLOGarray[RTSLOGindex_imWFS2].ENABLE
        = AOloopControl_readParam_int("RTstreamLOG_imWFS2_ENABLE",               1,
                                      fplog);
    AOconf[loop].RTSLOGarray[RTSLOGindex_imWFS2].ON
        = AOloopControl_readParam_int("RTstreamLOG_imWFS2_ON",                   1,
                                      fplog);
    AOconf[loop].RTSLOGarray[RTSLOGindex_imWFS2].save
        = AOloopControl_readParam_int("RTstreamLOG_imWFS2_save",                 0,
                                      fplog);

    AOconf[loop].RTSLOGarray[RTSLOGindex_modeval].ENABLE
        = AOloopControl_readParam_int("RTstreamLOG_modeval_ENABLE",              1,
                                      fplog);
    AOconf[loop].RTSLOGarray[RTSLOGindex_modeval].ON
        = AOloopControl_readParam_int("RTstreamLOG_modeval_ON",                  1,
                                      fplog);
    AOconf[loop].RTSLOGarray[RTSLOGindex_modeval].save
        = AOloopControl_readParam_int("RTstreamLOG_modeval_save",                0,
                                      fplog);

    AOconf[loop].RTSLOGarray[RTSLOGindex_modeval_dm_corr].ENABLE
        = AOloopControl_readParam_int("RTstreamLOG_modeval_dm_corr_ENABLE",      1,
                                      fplog);
    AOconf[loop].RTSLOGarray[RTSLOGindex_modeval_dm_corr].ON
        = AOloopControl_readParam_int("RTstreamLOG_modeval_dm_corr_ON",          1,
                                      fplog);
    AOconf[loop].RTSLOGarray[RTSLOGindex_modeval_dm_corr].save
        = AOloopControl_readParam_int("RTstreamLOG_modeval_dm_corr_save",        0,
                                      fplog);

    AOconf[loop].RTSLOGarray[RTSLOGindex_modeval_dm_now].ENABLE
        = AOloopControl_readParam_int("RTstreamLOG_modeval_dm_now_ENABLE",       1,
                                      fplog);
    AOconf[loop].RTSLOGarray[RTSLOGindex_modeval_dm_now].ON
        = AOloopControl_readParam_int("RTstreamLOG_modeval_dm_now_ON",           1,
                                      fplog);
    AOconf[loop].RTSLOGarray[RTSLOGindex_modeval_dm_now].save
        = AOloopControl_readParam_int("RTstreamLOG_modeval_dm_now_save",         0,
                                      fplog);

    AOconf[loop].RTSLOGarray[RTSLOGindex_modeval_dm_now_filt].ENABLE
        = AOloopControl_readParam_int("RTstreamLOG_modeval_dm_now_filt_ENABLE",  1,
                                      fplog);
    AOconf[loop].RTSLOGarray[RTSLOGindex_modeval_dm_now_filt].ON
        = AOloopControl_readParam_int("RTstreamLOG_modeval_dm_now_filt_ON",      1,
                                      fplog);
    AOconf[loop].RTSLOGarray[RTSLOGindex_modeval_dm_now_filt].save
        = AOloopControl_readParam_int("RTstreamLOG_modeval_dm_now_filt_save",    0,
                                      fplog);

    AOconf[loop].RTSLOGarray[RTSLOGindex_modevalPF].ENABLE
        = AOloopControl_readParam_int("RTstreamLOG_modevalPF_ENABLE",            1,
                                      fplog);
    AOconf[loop].RTSLOGarray[RTSLOGindex_modevalPF].ON
        = AOloopControl_readParam_int("RTstreamLOG_modevalPF_ON",                1,
                                      fplog);
    AOconf[loop].RTSLOGarray[RTSLOGindex_modevalPF].save
        = AOloopControl_readParam_int("RTstreamLOG_modevalPF_save",              0,
                                      fplog);

    AOconf[loop].RTSLOGarray[RTSLOGindex_modevalPFsync].ENABLE
        = AOloopControl_readParam_int("RTstreamLOG_modevalPFsync_ENABLE",        1,
                                      fplog);
    AOconf[loop].RTSLOGarray[RTSLOGindex_modevalPFsync].ON
        = AOloopControl_readParam_int("RTstreamLOG_modevalPFsync_ON",            1,
                                      fplog);
    AOconf[loop].RTSLOGarray[RTSLOGindex_modevalPFsync].save
        = AOloopControl_readParam_int("RTstreamLOG_modevalPFsync_save",          0,
                                      fplog);

    AOconf[loop].RTSLOGarray[RTSLOGindex_modevalPFres].ENABLE
        = AOloopControl_readParam_int("RTstreamLOG_modevalPFres_ENABLE",         1,
                                      fplog);
    AOconf[loop].RTSLOGarray[RTSLOGindex_modevalPFres].ON
        = AOloopControl_readParam_int("RTstreamLOG_modevalPFres_ON",             1,
                                      fplog);
    AOconf[loop].RTSLOGarray[RTSLOGindex_modevalPFres].save
        = AOloopControl_readParam_int("RTstreamLOG_modevalPFres_save",           0,
                                      fplog);

    AOconf[loop].RTSLOGarray[RTSLOGindex_modeval_dm].ENABLE
        = AOloopControl_readParam_int("RTstreamLOG_modeval_dm_ENABLE",           1,
                                      fplog);
    AOconf[loop].RTSLOGarray[RTSLOGindex_modeval_dm].ON
        = AOloopControl_readParam_int("RTstreamLOG_modeval_dm_ON",               1,
                                      fplog);
    AOconf[loop].RTSLOGarray[RTSLOGindex_modeval_dm].save
        = AOloopControl_readParam_int("RTstreamLOG_modeval_dm_save",             0,
                                      fplog);

    AOconf[loop].RTSLOGarray[RTSLOGindex_modeval_ol].ENABLE
        = AOloopControl_readParam_int("RTstreamLOG_modeval_ol_ENABLE",           1,
                                      fplog);
    AOconf[loop].RTSLOGarray[RTSLOGindex_modeval_ol].ON
        = AOloopControl_readParam_int("RTstreamLOG_modeval_ol_ON",               1,
                                      fplog);
    AOconf[loop].RTSLOGarray[RTSLOGindex_modeval_ol].save
        = AOloopControl_readParam_int("RTstreamLOG_modeval_ol_save",             0,
                                      fplog);

    AOconf[loop].RTSLOGarray[RTSLOGindex_dmC].ENABLE
        = AOloopControl_readParam_int("RTstreamLOG_dmdisp_ENABLE",               1,
                                      fplog);
    AOconf[loop].RTSLOGarray[RTSLOGindex_dmC].ON
        = AOloopControl_readParam_int("RTstreamLOG_dmdisp_ON",                   1,
                                      fplog);
    AOconf[loop].RTSLOGarray[RTSLOGindex_dmC].save
        = AOloopControl_readParam_int("RTstreamLOG_dmdisp_save",                 0,
                                      fplog);
    ...
    aoloopcontrol_var.aoconfID_dmdisp = read_sharedmem_image(
    ...
    AOloopControl_RTstreamLOG_setup(loop, RTSLOGindex_dmdisp,
                                    AOconf[loop].DMctrl.dmdispname);
    ...
    AOconf[loop].WFSim.sizexWFS =
        data.image[aoloopcontrol_var.aoconfID_wfsim].md[0].size[0];
    AOconf[loop].WFSim.sizeyWFS =
        data.image[aoloopcontrol_var.aoconfID_wfsim].md[0].size[1];
    AOconf[loop].WFSim.sizeWFS = AOconf[loop].WFSim.sizexWFS *
                                 AOconf[loop].WFSim.sizeyWFS;
    ...
    AOloopControl_RTstreamLOG_setup(loop, RTSLOGindex_wfsim,
                                    AOconf[loop].WFSim.WFSname);
    ...
    fprintf(fplog, "Connecting to %s [%s]...", name, " ");
    aoloopcontrol_var.aoconfID_imWFS0tot = AOloopControl_IOtools_2Dloadcreate_shmim(
            name, " ", 1, 1, 0.0);
    ...
    aoloopcontrol_var.aoconfID_imWFSlinlimit =
        AOloopControl_IOtools_2Dloadcreate_shmim(name, " ", AOconf[loop].WFSim.sizexWFS,
                AOconf[loop].WFSim.sizeyWFS, 1.0);
    fprintf(fplog, " ID = %ld\n", aoloopcontrol_var.aoconfID_imWFSlinlimit);
    ...
    if(aoloopcontrol_var.aoconfID_dmC == -1)
    {
        ...
        aoloopcontrol_var.aoconfID_dmC = read_sharedmem_image(
                                             AOconf[loop].DMctrl.dmCname);
        if(aoloopcontrol_var.aoconfID_dmC == -1)
        {
    ...
    AOconf[loop].DMctrl.sizexDM =
        data.image[aoloopcontrol_var.aoconfID_dmC].md[0].size[0];
    AOconf[loop].DMctrl.sizeyDM =
        data.image[aoloopcontrol_var.aoconfID_dmC].md[0].size[1];
    ...
    ///
    aoloopcontrol_var.aoconfID_DMmodes = image_ID(
            AOconf[loop].AOpmodecoeffs.DMmodesname);
    if(aoloopcontrol_var.aoconfID_DMmodes == -1)
    {
        printf("connect to %s\n", AOconf[loop].AOpmodecoeffs.DMmodesname);
        aoloopcontrol_var.aoconfID_DMmodes = read_sharedmem_image(
                AOconf[loop].AOpmodecoeffs.DMmodesname);
        if(aoloopcontrol_var.aoconfID_DMmodes == -1)
        {
    ...
    if(level >= 10)
    {
        ...
        aoloopcontrol_var.aoconfID_cmd_modes = AOloopControl_IOtools_2Dloadcreate_shmim(
                name, "", AOconf[loop].AOpmodecoeffs.NBDMmodes, 1, 0.0);
        ...
        aoloopcontrol_var.aoconfID_meas_modes =
            AOloopControl_IOtools_2Dloadcreate_shmim(name, "",
                    AOconf[loop].AOpmodecoeffs.NBDMmodes, 1, 0.0);

        if(sprintf(name, "aol%ld_DMmode_AVE", loop) < 1)
        {
            PRINT_ERROR("sprintf wrote <1 char");
        }
        aoloopcontrol_var.aoconfID_AVE_modes = AOloopControl_IOtools_2Dloadcreate_shmim(
                name, "", AOconf[loop].AOpmodecoeffs.NBDMmodes, 1, 0.0);
        ...
        aoloopcontrol_var.aoconfID_RMS_modes = AOloopControl_IOtools_2Dloadcreate_shmim(
                name, "", AOconf[loop].AOpmodecoeffs.NBDMmodes, 1, 0.0);
        ...
        aoloopcontrol_var.aoconfID_DMmode_GAIN =
            AOloopControl_IOtools_2Dloadcreate_shmim(name, "",
                    AOconf[loop].AOpmodecoeffs.NBDMmodes, 1, 1.0);
        ...
        for(unsigned long ii = 0;
                ii < AOconf[loop].WFSim.sizexWFS * AOconf[loop].WFSim.sizeyWFS; ii++)
        ...
        aoconfID_respM = AOloopControl_IOtools_3Dloadcreate_shmim(
                             AOconf[loop].aorun.respMname, fname, AOconf[loop].WFSim.sizexWFS,
                             AOconf[loop].WFSim.sizeyWFS, AOconf[loop].AOpmodecoeffs.NBDMmodes, 0.0);
        ...
        aoloopcontrol_var.aoconfID_contrM = AOloopControl_IOtools_3Dloadcreate_shmim(
                                                AOconf[loop].aorun.contrMname, fname, AOconf[loop].WFSim.sizexWFS,
                                                AOconf[loop].WFSim.sizeyWFS, AOconf[loop].AOpmodecoeffs.NBDMmodes, 0.0);
        ...
        aoloopcontrol_var.aoconfID_contrMc = AOloopControl_IOtools_3Dloadcreate_shmim(
                name, fname, AOconf[loop].WFSim.sizexWFS, AOconf[loop].WFSim.sizeyWFS,
                AOconf[loop].DMctrl.sizeDM, 0.0);
        ...
        aoloopcontrol_var.aoconfID_contrMcact[0] =
            AOloopControl_IOtools_2Dloadcreate_shmim(name, fname,
        ...
        for(kk = 0; kk < AOconf[loop].AOpmodecoeffs.DMmodesNBblock; kk++)
        {
            ...
            fflush(stdout);
            if((ID = AOloopControl_IOtools_3Dloadcreate_shmim(name, fname,
                     AOconf[loop].DMctrl.sizexDM, AOconf[loop].DMctrl.sizeyDM, 0, 0.0)) != -1)
            {
                AOconf[loop].AOpmodecoeffs.NBmodes_block[kk] = data.image[ID].md[0].size[2];
            }


            for(unsigned int m = mstart;
                    m < (mstart + AOconf[loop].AOpmodecoeffs.NBmodes_block[kk]); m++)
            {
            ...
            printf("====== LOADING %s to %s\n", fname, name);
            fflush(stdout);
            AOloopControl_IOtools_3Dloadcreate_shmim(name, fname,
                    AOconf[loop].WFSim.sizexWFS, AOconf[loop].WFSim.sizeyWFS,
                    AOconf[loop].AOpmodecoeffs.NBmodes_block[kk], 0.0);
            ...
            ID = AOloopControl_IOtools_3Dloadcreate_shmim(name, fname,
                    AOconf[loop].WFSim.sizexWFS, AOconf[loop].WFSim.sizeyWFS,
                    AOconf[loop].DMctrl.sizexDM * AOconf[loop].DMctrl.sizeyDM, 0.0);
            if(kk == 0)
            {
                for(unsigned long ii = 0;
    ...
    {
        AOconf[loop].AOpmodecoeffs.indexmaxMB[0] =
            AOconf[loop].AOpmodecoeffs.NBDMmodes;
    }
    else
    {
