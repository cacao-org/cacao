...
//    char command[stringmaxlen];
    ...
    strncpy(outdirname, functionparameter_GetParamPtr_STRING(&fps, ".conf.outdir"),
            FUNCTION_PARAMETER_STRMAXLEN);
 ...
 *
 */
errno_t AOloopControl_perfTest_mkTimingFile(
    char *inTimingfname,
    char *outTimingfname,
    char *tmpstring
)
...
errno_t AOloopControl_perfTest_StatAnalysis_2streams(
    char *IDname_stream0,
    char *IDname_stream1,
    char *IDname_simM0,
    char *IDname_simM1,
