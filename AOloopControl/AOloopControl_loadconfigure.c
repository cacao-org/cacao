...
errno_t AOloopControl_loadconfigure(long loop, int mode, int level)
{
   ...
   */
    ...
    AOconf[loop].WFSim.WFSnormalize =
        AOloopControl_readParam_int("WFSnorm", 1, fplog);
   ...
   */
    ...
    AOconf[loop].AOtiminginfo.loopfrequ =
        AOloopControl_readParam_float("loopfrequ", 1000.0, fplog);
    AOconf[loop].AOtiminginfo.hardwlatency =
   ...
   */
    ...
    AOconf[loop].AOcompute.GPUall = AOloopControl_readParam_int(
        "GPUall",
        0,
        fplog); // Skip CPU image scaling and go straight to GPUs ?
    AOconf[loop].aorun.DMprimaryWriteON =
        AOloopControl_readParam_int("DMprimaryWriteON",
                                    0,
                                    fplog); // Direct DM write ?
    AOconf[loop].aorun.DMfilteredWriteON =
        AOloopControl_readParam_int("DMfilteredWriteON",
                                    0,
   ...
   */
    ...
    AOconf[loop].RTLOGsize =
        AOloopControl_readParam_int("RTLOGsize", 30000, fplog);
    ...
    AOconf[loop].RTSLOGarray[RTSLOGindex_wfsim].ON =
        AOloopControl_readParam_int("RTstreamLOG_wfsim_ON", 1, fplog);
    AOconf[loop].RTSLOGarray[RTSLOGindex_wfsim].save =
        AOloopControl_readParam_int("RTstreamLOG_wfsim_save", 0, fplog);
    ...
    AOconf[loop].RTSLOGarray[RTSLOGindex_imWFS0].ON =
        AOloopControl_readParam_int("RTstreamLOG_imWFS0_ON", 1, fplog);
    ...
    AOconf[loop].RTSLOGarray[RTSLOGindex_imWFS1].ON =
        AOloopControl_readParam_int("RTstreamLOG_imWFS1_ON", 1, fplog);
    ...
    AOconf[loop].RTSLOGarray[RTSLOGindex_imWFS2].ON =
        AOloopControl_readParam_int("RTstreamLOG_imWFS2_ON", 1, fplog);
    ...
    AOconf[loop].RTSLOGarray[RTSLOGindex_modeval].ON =
        AOloopControl_readParam_int("RTstreamLOG_modeval_ON", 1, fplog);
    ...
    AOconf[loop].RTSLOGarray[RTSLOGindex_modeval_dm_corr].ENABLE =
        AOloopControl_readParam_int("RTstreamLOG_modeval_dm_corr_ENABLE",
                                    1,
                                    fplog);
    ...
    AOconf[loop].RTSLOGarray[RTSLOGindex_modeval_dm_corr].save =
        AOloopControl_readParam_int("RTstreamLOG_modeval_dm_corr_save",
                                    0,
                                    fplog);

    AOconf[loop].RTSLOGarray[RTSLOGindex_modeval_dm_now].ENABLE =
        AOloopControl_readParam_int("RTstreamLOG_modeval_dm_now_ENABLE",
                                    1,
                                    fplog);
    ...
    AOconf[loop].RTSLOGarray[RTSLOGindex_modeval_dm_now].save =
        AOloopControl_readParam_int("RTstreamLOG_modeval_dm_now_save",
                                    0,
                                    fplog);

    AOconf[loop].RTSLOGarray[RTSLOGindex_modeval_dm_now_filt].ENABLE =
        AOloopControl_readParam_int("RTstreamLOG_modeval_dm_now_filt_ENABLE",
                                    1,
                                    fplog);
    AOconf[loop].RTSLOGarray[RTSLOGindex_modeval_dm_now_filt].ON =
        AOloopControl_readParam_int("RTstreamLOG_modeval_dm_now_filt_ON",
                                    1,
                                    fplog);
    AOconf[loop].RTSLOGarray[RTSLOGindex_modeval_dm_now_filt].save =
        AOloopControl_readParam_int("RTstreamLOG_modeval_dm_now_filt_save",
                                    0,
                                    fplog);
    ...
    AOconf[loop].RTSLOGarray[RTSLOGindex_modevalPFsync].ENABLE =
        AOloopControl_readParam_int("RTstreamLOG_modevalPFsync_ENABLE",
                                    1,
                                    fplog);
    ...
    AOconf[loop].RTSLOGarray[RTSLOGindex_modevalPFres].ENABLE =
        AOloopControl_readParam_int("RTstreamLOG_modevalPFres_ENABLE",
                                    1,
                                    fplog);
    ...
    AOconf[loop].RTSLOGarray[RTSLOGindex_dmC].ON =
        AOloopControl_readParam_int("RTstreamLOG_dmdisp_ON", 1, fplog);
    AOconf[loop].RTSLOGarray[RTSLOGindex_dmC].save =
        AOloopControl_readParam_int("RTstreamLOG_dmdisp_save", 0, fplog);
   ...
   */
    ...
    aoloopcontrol_var.aoconfID_dmdisp =
        read_sharedmem_image(AOconf[loop].DMctrl.dmdispname);
   ...
   */
    ...
    AOconf[loop].DMctrl.DMMODE =
        AOloopControl_readParam_int("DMMODE",
                                    0,
    ...
    if (aoloopcontrol_var.aoconfID_dmC == -1)
    {
        ...
        aoloopcontrol_var.aoconfID_dmC =
            read_sharedmem_image(AOconf[loop].DMctrl.dmCname);
        if (aoloopcontrol_var.aoconfID_dmC == -1)
        {
   ...
   */
    ...
    aoloopcontrol_var.aoconfID_DMmodes =
        image_ID(AOconf[loop].AOpmodecoeffs.DMmodesname);
    if (aoloopcontrol_var.aoconfID_DMmodes == -1)
    {
        printf("connect to %s\n", AOconf[loop].AOpmodecoeffs.DMmodesname);
        aoloopcontrol_var.aoconfID_DMmodes =
            read_sharedmem_image(AOconf[loop].AOpmodecoeffs.DMmodesname);
        if (aoloopcontrol_var.aoconfID_DMmodes == -1)
        {
   ...
   * */
    ...
    if (level >= 10) // Load DM modes (will exit if not successful)
    {
       ...
       */
        ...
        if (aoloopcontrol_var.aoconfID_DMmodes == -1) // If not, check file
        {
            ...
            {
                printf(
                    "ERROR: File \"%s\" has wrong x size: should be %u, is "
                    "%u\n",
                    fname,
                    AOconf[loop].DMctrl.sizexDM,
            ...
            {
                printf(
                    "ERROR: File \"%s\" has wrong y size: should be %u, is "
                    "%u\n",
                    fname,
                    AOconf[loop].DMctrl.sizeyDM,
            ...
            if (ID2tmp != -1) // if shared memory exists, check its size
            {
                ...
                {
                    printf(
                        "ERROR: Shared memory File %s is not a 3D image "
                        "(cube)\n",
                        AOconf[loop].AOpmodecoeffs.DMmodesname);
                    vOK = 0;
                }
                if (data.image[ID2tmp].md[0].size[0] !=
                    AOconf[loop].DMctrl.sizexDM)
                {
                    printf(
                        "ERROR: Shared memory File %s has wrong x size: "
                        "should be %u, is %u\n",
                        AOconf[loop].AOpmodecoeffs.DMmodesname,
                        AOconf[loop].DMctrl.sizexDM,
                ...
                if (data.image[ID2tmp].md[0].size[1] !=
                    AOconf[loop].DMctrl.sizeyDM)
                {
                    printf(
                        "ERROR: Shared memory File %s has wrong y size: "
                        "should be %u, is %u\n",
                        AOconf[loop].AOpmodecoeffs.DMmodesname,
                        AOconf[loop].DMctrl.sizeyDM,
                ...
                if (data.image[ID2tmp].md[0].size[2] !=
                    AOconf[loop].AOpmodecoeffs.NBDMmodes)
                {
                    printf(
                        "ERROR: Shared memory File %s has wrong y size: "
            ...
            case _DATATYPE_FLOAT:
                memcpy(data.image[aoloopcontrol_var.aoconfID_DMmodes].array.F,
                       ...
                       sizeof(float) * AOconf[loop].DMctrl.sizexDM *
                           AOconf[loop].DMctrl.sizeyDM *
                           AOconf[loop].AOpmodecoeffs.NBDMmodes);
                break;
            case _DATATYPE_DOUBLE:
                for (unsigned long ii = 0;
                     ii < AOconf[loop].DMctrl.sizexDM *
                              AOconf[loop].DMctrl.sizeyDM *
                              AOconf[loop].AOpmodecoeffs.NBDMmodes;
                     ii++)
                {
    ...
    if (level >= 10)
    {
        ...
        aoloopcontrol_var.aoconfID_wfsmask =
            AOloopControl_IOtools_2Dloadcreate_shmim(
                name,
                fname,
                AOconf[loop].WFSim.sizexWFS,
        ...
        for (unsigned long ii = 0;
             ...
             ii++)
            if (data.image[aoloopcontrol_var.aoconfID_wfsmask].array.F[ii] >
                0.5)
            {
        ...
        aoloopcontrol_var.aoconfID_dmmask =
            AOloopControl_IOtools_2Dloadcreate_shmim(
                name,
                fname,
                AOconf[loop].DMctrl.sizexDM,
        ...
        {
            printf(
                "Cannot open conf/param_NBmodeblocks.txt.... assuming 1 "
                "block\n");
        ...
        else
        {
            ...
            {
                printf(
                    "Cannot read conf/param_NBmodeblocks.txt.... assuming 1 "
                    "block\n");
                AOconf[loop].AOpmodecoeffs.DMmodesNBblock = 1;
            }
            fclose(fp);
        ...
        for (kk = 0; kk < AOconf[loop].AOpmodecoeffs.DMmodesNBblock; kk++)
        {
            ...
            for (unsigned int m = mstart;
                 m < (mstart + AOconf[loop].AOpmodecoeffs.NBmodes_block[kk]);
                 m++)
            {
            ...
            {
                for (unsigned long ii = 0;
                     ii < AOconf[loop].WFSim.activeWFScnt *
                              AOconf[loop].DMctrl.activeDMcnt;
                     ii++)
                {
                    data.image[aoloopcontrol_var.aoconfID_contrMcact[0]]
                        .array.F[ii] = 0.0;
                }
            }

            for (unsigned long ii = 0; ii < AOconf[loop].WFSim.activeWFScnt *
                                                AOconf[loop].DMctrl.activeDMcnt;
                 ii++)
            {
                data.image[aoloopcontrol_var.aoconfID_contrMcact[0]]
    ...
    else
    {
        ...
        for (unsigned int k = 1; k < AOconf[loop].AOpmodecoeffs.DMmodesNBblock;
             k++)
        {
