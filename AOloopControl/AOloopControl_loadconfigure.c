...
{
    FILE *fp;
    char content[STRINGMAXLEN_DEFAULT];
   ...
   * AOconf[loop].AOtiminginfo.hardwlatency *
   * AOconf[loop].AOloopTimingInfo.loopfrequ
   * - ./conf/param_complatency.txt  -> AOconf[loop].AOtiminginfo.complatency
   * - AOconf[loop].AOtiminginfo.complatency_frame =
   * AOconf[loop].AOtiminginfo.complatency *
   * AOconf[loop].AOloopTimingInfo.loopfrequ;
   * - ./conf/param_wfsmextrlatency.txt ->
   * AOconf[loop].AOloopTimingInfo.wfsmextrlatency
   */
    fprintf(fplog, "\n\n============== 1.5. Read Timing info ===================\n\n");
    ...
    AOconf[loop].AOtiminginfo.hardwlatency_frame =
        AOconf[loop].AOtiminginfo.hardwlatency * AOconf[loop].AOtiminginfo.loopfrequ;

    AOconf[loop].AOtiminginfo.complatency = AOloopControl_readParam_float("complatency", 0.0, fplog);
    AOconf[loop].AOtiminginfo.complatency_frame =
        AOconf[loop].AOtiminginfo.complatency * AOconf[loop].AOtiminginfo.loopfrequ;
    ...
    AOconf[loop].AOtiminginfo.wfsmextrlatency_frame =
        AOconf[loop].AOtiminginfo.wfsmextrlatency * AOconf[loop].AOtiminginfo.loopfrequ;

    /** ### 1.6. Define GPU use
   *
   * - ./conf/param_GPU0.txt           > AOconf[loop].AOcompute.GPU0 (0 if
   * missing)
   * - ./conf/param_GPU1.txt           > AOconf[loop].AOcompute.GPU1 (0 if
   * missing)
   ...
   */
    ...
    AOconf[loop].AOcompute.GPUall =
        AOloopControl_readParam_int("GPUall",
                                    0,
                                    fplog); // Skip CPU image scaling and go straight to GPUs ?
    AOconf[loop].aorun.DMprimaryWriteON = AOloopControl_readParam_int("DMprimaryWriteON",
                                                                      0,
                                                                      fplog); // Direct DM write ?
    AOconf[loop].aorun.DMfilteredWriteON = AOloopControl_readParam_int("DMfilteredWriteON",
                                                                       0,
                                                                       fplog); // Filtered DM write ?
   ...
   * 		- 0 : WFS signal -> Mode coeffs -> DM act values  (2 sequential
   * matrix multiplications)
   * 		- 1 : WFS signal -> DM act values  (1 combined matrix
   * multiplication)
   */
   ...
   */
    ...
    aoloopcontrol_var.aoconfID_looptiming =
        AOloopControl_IOtools_2Dloadcreate_shmim(name, " ", aoloopcontrol_var.AOcontrolNBtimers, 1, 0.0);
   ...
   */
    ...
    AOconf[loop].RTSLOGarray[RTSLOGindex_wfsim].ENABLE =
        AOloopControl_readParam_int("RTstreamLOG_wfsim_ENABLE", 1, fplog);
    ...
    AOconf[loop].RTSLOGarray[RTSLOGindex_imWFS0].ENABLE =
        AOloopControl_readParam_int("RTstreamLOG_imWFS0_ENABLE", 1, fplog);
    AOconf[loop].RTSLOGarray[RTSLOGindex_imWFS0].ON = AOloopControl_readParam_int("RTstreamLOG_imWFS0_ON", 1, fplog);
    AOconf[loop].RTSLOGarray[RTSLOGindex_imWFS0].save =
        AOloopControl_readParam_int("RTstreamLOG_imWFS0_save", 0, fplog);

    AOconf[loop].RTSLOGarray[RTSLOGindex_imWFS1].ENABLE =
        AOloopControl_readParam_int("RTstreamLOG_imWFS1_ENABLE", 1, fplog);
    AOconf[loop].RTSLOGarray[RTSLOGindex_imWFS1].ON = AOloopControl_readParam_int("RTstreamLOG_imWFS1_ON", 1, fplog);
    AOconf[loop].RTSLOGarray[RTSLOGindex_imWFS1].save =
        AOloopControl_readParam_int("RTstreamLOG_imWFS1_save", 0, fplog);

    AOconf[loop].RTSLOGarray[RTSLOGindex_imWFS2].ENABLE =
        AOloopControl_readParam_int("RTstreamLOG_imWFS2_ENABLE", 1, fplog);
    AOconf[loop].RTSLOGarray[RTSLOGindex_imWFS2].ON = AOloopControl_readParam_int("RTstreamLOG_imWFS2_ON", 1, fplog);
    AOconf[loop].RTSLOGarray[RTSLOGindex_imWFS2].save =
        AOloopControl_readParam_int("RTstreamLOG_imWFS2_save", 0, fplog);

    AOconf[loop].RTSLOGarray[RTSLOGindex_modeval].ENABLE =
        AOloopControl_readParam_int("RTstreamLOG_modeval_ENABLE", 1, fplog);
    AOconf[loop].RTSLOGarray[RTSLOGindex_modeval].ON = AOloopControl_readParam_int("RTstreamLOG_modeval_ON", 1, fplog);
    AOconf[loop].RTSLOGarray[RTSLOGindex_modeval].save =
        AOloopControl_readParam_int("RTstreamLOG_modeval_save", 0, fplog);

    AOconf[loop].RTSLOGarray[RTSLOGindex_modeval_dm_corr].ENABLE =
        AOloopControl_readParam_int("RTstreamLOG_modeval_dm_corr_ENABLE", 1, fplog);
    AOconf[loop].RTSLOGarray[RTSLOGindex_modeval_dm_corr].ON =
        AOloopControl_readParam_int("RTstreamLOG_modeval_dm_corr_ON", 1, fplog);
    AOconf[loop].RTSLOGarray[RTSLOGindex_modeval_dm_corr].save =
        AOloopControl_readParam_int("RTstreamLOG_modeval_dm_corr_save", 0, fplog);

    AOconf[loop].RTSLOGarray[RTSLOGindex_modeval_dm_now].ENABLE =
        AOloopControl_readParam_int("RTstreamLOG_modeval_dm_now_ENABLE", 1, fplog);
    AOconf[loop].RTSLOGarray[RTSLOGindex_modeval_dm_now].ON =
        AOloopControl_readParam_int("RTstreamLOG_modeval_dm_now_ON", 1, fplog);
    AOconf[loop].RTSLOGarray[RTSLOGindex_modeval_dm_now].save =
        AOloopControl_readParam_int("RTstreamLOG_modeval_dm_now_save", 0, fplog);

    AOconf[loop].RTSLOGarray[RTSLOGindex_modeval_dm_now_filt].ENABLE =
        AOloopControl_readParam_int("RTstreamLOG_modeval_dm_now_filt_ENABLE", 1, fplog);
    AOconf[loop].RTSLOGarray[RTSLOGindex_modeval_dm_now_filt].ON =
        AOloopControl_readParam_int("RTstreamLOG_modeval_dm_now_filt_ON", 1, fplog);
    AOconf[loop].RTSLOGarray[RTSLOGindex_modeval_dm_now_filt].save =
        AOloopControl_readParam_int("RTstreamLOG_modeval_dm_now_filt_save", 0, fplog);

    AOconf[loop].RTSLOGarray[RTSLOGindex_modevalPF].ENABLE =
        AOloopControl_readParam_int("RTstreamLOG_modevalPF_ENABLE", 1, fplog);
    AOconf[loop].RTSLOGarray[RTSLOGindex_modevalPF].ON =
        AOloopControl_readParam_int("RTstreamLOG_modevalPF_ON", 1, fplog);
    AOconf[loop].RTSLOGarray[RTSLOGindex_modevalPF].save =
        AOloopControl_readParam_int("RTstreamLOG_modevalPF_save", 0, fplog);

    AOconf[loop].RTSLOGarray[RTSLOGindex_modevalPFsync].ENABLE =
        AOloopControl_readParam_int("RTstreamLOG_modevalPFsync_ENABLE", 1, fplog);
    AOconf[loop].RTSLOGarray[RTSLOGindex_modevalPFsync].ON =
        AOloopControl_readParam_int("RTstreamLOG_modevalPFsync_ON", 1, fplog);
    AOconf[loop].RTSLOGarray[RTSLOGindex_modevalPFsync].save =
        AOloopControl_readParam_int("RTstreamLOG_modevalPFsync_save", 0, fplog);

    AOconf[loop].RTSLOGarray[RTSLOGindex_modevalPFres].ENABLE =
        AOloopControl_readParam_int("RTstreamLOG_modevalPFres_ENABLE", 1, fplog);
    AOconf[loop].RTSLOGarray[RTSLOGindex_modevalPFres].ON =
        AOloopControl_readParam_int("RTstreamLOG_modevalPFres_ON", 1, fplog);
    AOconf[loop].RTSLOGarray[RTSLOGindex_modevalPFres].save =
        AOloopControl_readParam_int("RTstreamLOG_modevalPFres_save", 0, fplog);

    AOconf[loop].RTSLOGarray[RTSLOGindex_modeval_dm].ENABLE =
        AOloopControl_readParam_int("RTstreamLOG_modeval_dm_ENABLE", 1, fplog);
    AOconf[loop].RTSLOGarray[RTSLOGindex_modeval_dm].ON =
        AOloopControl_readParam_int("RTstreamLOG_modeval_dm_ON", 1, fplog);
    AOconf[loop].RTSLOGarray[RTSLOGindex_modeval_dm].save =
        AOloopControl_readParam_int("RTstreamLOG_modeval_dm_save", 0, fplog);

    AOconf[loop].RTSLOGarray[RTSLOGindex_modeval_ol].ENABLE =
        AOloopControl_readParam_int("RTstreamLOG_modeval_ol_ENABLE", 1, fplog);
    AOconf[loop].RTSLOGarray[RTSLOGindex_modeval_ol].ON =
        AOloopControl_readParam_int("RTstreamLOG_modeval_ol_ON", 1, fplog);
    AOconf[loop].RTSLOGarray[RTSLOGindex_modeval_ol].save =
        AOloopControl_readParam_int("RTstreamLOG_modeval_ol_save", 0, fplog);

    AOconf[loop].RTSLOGarray[RTSLOGindex_dmC].ENABLE =
        AOloopControl_readParam_int("RTstreamLOG_dmdisp_ENABLE", 1, fplog);
   ...
   *
   *  - AOconf[loop].DMctrl.dmdispname  : this image is read to notify when new
   * dm displacement is ready
   *  - AOconf[loop].WFSim.WFSname     : connect to WFS camera. This is where
   * the size of the WFS is read
   */
    ...
    if (aoloopcontrol_var.aoconfID_dmdisp == -1)
    ...
    else
        {
            fprintf(fplog,
                    ...
                    AOconf[loop].DMctrl.dmdispname,
                    aoloopcontrol_var.aoconfID_dmdisp);
        }
   ...
   *
   *  The AOloopControl_xDloadcreate_shmim functions are used, and follows these
   * rules:
   *
   * If file already loaded, use it (we assume it's already been properly
   * loaded) \n If not, attempt to read it from shared memory \n If not
   * available in shared memory, create it in shared memory \n if "fname"
   * exists, attempt to load it into the shared memory image
   *
   ...
   */
    ...
    fprintf(fplog,
            "\n\n============== 2.2. --- Read file to stream or connect to "
            "existing stream  ===================\n\n");
    ...
    sprintf(fname, "./conf/shmim.wfsdark.fits");

    fprintf(fplog, "Connecting to %s [%s]...", name, fname);
    fflush(stdout);
    aoloopcontrol_var.aoconfID_wfsdark = AOloopControl_IOtools_2Dloadcreate_shmim(
        name, fname, AOconf[loop].WFSim.sizexWFS, AOconf[loop].WFSim.sizeyWFS, 0.0);
    fprintf(fplog, " ID = %ld\n", aoloopcontrol_var.aoconfID_wfsdark);
    ...
    aoloopcontrol_var.aoconfID_imWFS0 = AOloopControl_IOtools_2Dloadcreate_shmim(
        name, " ", AOconf[loop].WFSim.sizexWFS, AOconf[loop].WFSim.sizeyWFS, 0.0);
    ...
    fprintf(fplog, "Connecting to %s [%s]...", name, " ");
    aoloopcontrol_var.aoconfID_imWFS1 = AOloopControl_IOtools_2Dloadcreate_shmim(
        name, " ", AOconf[loop].WFSim.sizexWFS, AOconf[loop].WFSim.sizeyWFS, 0.0);
    ...
    fprintf(fplog, "Connecting to %s [%s]...", name, " ");
    aoloopcontrol_var.aoconfID_imWFS2 = AOloopControl_IOtools_2Dloadcreate_shmim(
        name, " ", AOconf[loop].WFSim.sizexWFS, AOconf[loop].WFSim.sizeyWFS, 0.0);
    ...
    fprintf(fplog, "Connecting to %s [%s]...", name, " ");
    aoloopcontrol_var.aoconfID_imWFSlinlimit = AOloopControl_IOtools_2Dloadcreate_shmim(
        name, " ", AOconf[loop].WFSim.sizexWFS, AOconf[loop].WFSim.sizeyWFS, 1.0);
    ...
    if (sprintf(fname, "./conf/shmim.wfsref0.fits") < 1)
        {
            PRINT_ERROR("sprintf wrote <1 char");
        }

    fprintf(fplog, "Connecting to %s [%s]...", name, fname);
    aoloopcontrol_var.aoconfID_wfsref0 = AOloopControl_IOtools_2Dloadcreate_shmim(
        name, fname, AOconf[loop].WFSim.sizexWFS, AOconf[loop].WFSim.sizeyWFS, 0.0);
    ...
    if (sprintf(fname, "./conf/shmim.wfsref.fits") < 1)
        {
            PRINT_ERROR("sprintf wrote <1 char");
        }

    fprintf(fplog, "Connecting to %s [%s]...", name, fname);
    aoloopcontrol_var.aoconfID_wfsref = AOloopControl_IOtools_2Dloadcreate_shmim(
        name, fname, AOconf[loop].WFSim.sizexWFS, AOconf[loop].WFSim.sizeyWFS, 0.0);
   ...
   *
   *  Here the DM size is read -> Oconf[loop].DMctrl.sizexDM,
   * AOconf[loop].DMctrl.sizeyDM
   */

    AOconf[loop].DMctrl.DMMODE = AOloopControl_readParam_int("DMMODE", 0,
                                                             fplog); // zonal DM by default
   ...
   * */
            ...
            if (aoloopcontrol_var.aoconfID_DMmodes == -1) // If not, check file
                {
                    ...
                    if (sprintf(fname, "./conf/shmim.DMmodes.fits") < 1)
                        {
                            PRINT_ERROR("sprintf wrote <1 char");
                        }
                    ...
                    if (ID1tmp == -1)
                        {
                            ...
                            if (sprintf(fname, "./conf/shmim.DMmodes_zonal.fits") < 1)
                                {
                                    PRINT_ERROR("sprintf wrote <1 char");
                                }
                    ...
                    if (data.image[ID1tmp].md[0].size[0] != AOconf[loop].DMctrl.sizexDM)
                        {
                            printf("ERROR: File \"%s\" has wrong x size: should be %u, is "
                                   "%u\n",
                                   fname,
                                   AOconf[loop].DMctrl.sizexDM,
                                   data.image[ID1tmp].md[0].size[0]);
                            exit(0);
                        }
                    if (data.image[ID1tmp].md[0].size[1] != AOconf[loop].DMctrl.sizeyDM)
                        {
                            printf("ERROR: File \"%s\" has wrong y size: should be %u, is "
                                   "%u\n",
                                   fname,
                                   AOconf[loop].DMctrl.sizeyDM,
                                   data.image[ID1tmp].md[0].size[1]);
                            exit(0);
                        }
                    ...
                    if (ID2tmp != -1) // if shared memory exists, check its size
                        {
                            ...
                            if (data.image[ID2tmp].md[0].naxis != 3)
                                {
                                    printf("ERROR: Shared memory File %s is not a 3D image "
                                           "(cube)\n",
                                           AOconf[loop].AOpmodecoeffs.DMmodesname);
                                    vOK = 0;
                                }
                            if (data.image[ID2tmp].md[0].size[0] != AOconf[loop].DMctrl.sizexDM)
                                {
                                    printf("ERROR: Shared memory File %s has wrong x size: "
                                           "should be %u, is %u\n",
                                           AOconf[loop].AOpmodecoeffs.DMmodesname,
                                           AOconf[loop].DMctrl.sizexDM,
                            ...
                            if (data.image[ID2tmp].md[0].size[1] != AOconf[loop].DMctrl.sizeyDM)
                                {
                                    printf("ERROR: Shared memory File %s has wrong y size: "
                                           "should be %u, is %u\n",
                                           AOconf[loop].AOpmodecoeffs.DMmodesname,
                                           AOconf[loop].DMctrl.sizeyDM,
                    ...
                    if (vOK == 0) // create shared memory
                        {
                            ...
                            printf("Creating %s   [%ld x %ld x %ld]\n",
                                   ...
                                   (long)sizearray[2]);
                            fflush(stdout);
                            create_image_ID(AOconf[loop].AOpmodecoeffs.DMmodesname,
                                            3,
                                            sizearray,
                                            _DATATYPE_FLOAT,
                                            1,
                    ...
                    switch (data.image[ID1tmp].md[0].datatype)
                        ...
                        case _DATATYPE_DOUBLE:
                            for (unsigned long ii = 0; ii < AOconf[loop].DMctrl.sizexDM * AOconf[loop].DMctrl.sizeyDM *
                                                                AOconf[loop].AOpmodecoeffs.NBDMmodes;
                                 ii++)
                                {
    ...
    if (level >= 10)
        {
            ...
            aoloopcontrol_var.aoconfID_cmd_modes =
                AOloopControl_IOtools_2Dloadcreate_shmim(name, "", AOconf[loop].AOpmodecoeffs.NBDMmodes, 1, 0.0);
            ...
            aoloopcontrol_var.aoconfID_AVE_modes =
                AOloopControl_IOtools_2Dloadcreate_shmim(name, "", AOconf[loop].AOpmodecoeffs.NBDMmodes, 1, 0.0);
            ...
            aoloopcontrol_var.aoconfID_RMS_modes =
                AOloopControl_IOtools_2Dloadcreate_shmim(name, "", AOconf[loop].AOpmodecoeffs.NBDMmodes, 1, 0.0);
            ...
            aoloopcontrol_var.aoconfID_DMmode_GAIN =
                AOloopControl_IOtools_2Dloadcreate_shmim(name, "", AOconf[loop].AOpmodecoeffs.NBDMmodes, 1, 1.0);

            if (sprintf(name, "aol%ld_DMmode_LIMIT", loop) < 1)
                {
                    PRINT_ERROR("sprintf wrote <1 char");
                }
            aoloopcontrol_var.aoconfID_LIMIT_modes =
                AOloopControl_IOtools_2Dloadcreate_shmim(name, "", AOconf[loop].AOpmodecoeffs.NBDMmodes, 1, 1.0);
            ...
            aoloopcontrol_var.aoconfID_MULTF_modes =
                AOloopControl_IOtools_2Dloadcreate_shmim(name, "", AOconf[loop].AOpmodecoeffs.NBDMmodes, 1, 1.0);
            ...
            aoloopcontrol_var.aoconfID_wfsmask = AOloopControl_IOtools_2Dloadcreate_shmim(
                name, fname, AOconf[loop].WFSim.sizexWFS, AOconf[loop].WFSim.sizeyWFS, 1.0);
            AOconf[loop].WFSim.activeWFScnt = 0;
            for (unsigned long ii = 0; ii < AOconf[loop].WFSim.sizexWFS * AOconf[loop].WFSim.sizeyWFS; ii++)
            ...
            aoloopcontrol_var.aoconfID_dmmask = AOloopControl_IOtools_2Dloadcreate_shmim(
                name, fname, AOconf[loop].DMctrl.sizexDM, AOconf[loop].DMctrl.sizeyDM, 1.0);
            AOconf[loop].DMctrl.activeDMcnt = 0;
            for (unsigned long ii = 0; ii < AOconf[loop].DMctrl.sizexDM * AOconf[loop].DMctrl.sizeyDM; ii++)
                {
            ...
            if (sprintf(fname, "conf/shmim.respM.fits") < 1)
                {
                    PRINT_ERROR("sprintf wrote <1 char");
                }

            aoconfID_respM = AOloopControl_IOtools_3Dloadcreate_shmim(AOconf[loop].aorun.respMname,
                                                                      fname,
            ...
            if (sprintf(fname, "conf/shmim.contrM.fits") < 1)
                {
                    PRINT_ERROR("sprintf wrote <1 char");
                }

            aoloopcontrol_var.aoconfID_contrM =
                AOloopControl_IOtools_3Dloadcreate_shmim(AOconf[loop].aorun.contrMname,
                                                         fname,
                                                         AOconf[loop].WFSim.sizexWFS,
                                                         AOconf[loop].WFSim.sizeyWFS,
                                                         AOconf[loop].AOpmodecoeffs.NBDMmodes,
            ...
            if ((fp = fopen("conf/param_NBmodeblocks.txt", "r")) == NULL)
                {
                    printf("Cannot open conf/param_NBmodeblocks.txt.... assuming 1 "
                           "block\n");
            ...
            else
                {
                    if (fscanf(fp, "%50ld", &tmpl) == 1)
                        ...
                        {
                            printf("Cannot read conf/param_NBmodeblocks.txt.... assuming 1 "
                                   "block\n");
                            AOconf[loop].AOpmodecoeffs.DMmodesNBblock = 1;
                        }
                    fclose(fp);
            ...
            if (sprintf(fname, "conf/shmim.contrMc.fits") < 1)
                {
                    PRINT_ERROR("sprintf wrote <1 char");
                }
            aoloopcontrol_var.aoconfID_contrMc = AOloopControl_IOtools_3Dloadcreate_shmim(
                name, fname, AOconf[loop].WFSim.sizexWFS, AOconf[loop].WFSim.sizeyWFS, AOconf[loop].DMctrl.sizeDM, 0.0);

            if (sprintf(name, "aol%ld_contrMcact", loop) < 1)
                {
                    PRINT_ERROR("sprintf wrote <1 char");
                }
            if (sprintf(fname, "conf/shmim.contrMcact_00.fits") < 1)
                {
                    PRINT_ERROR("sprintf wrote <1 char");
                }
            aoloopcontrol_var.aoconfID_contrMcact[0] = AOloopControl_IOtools_2Dloadcreate_shmim(
                name, fname, AOconf[loop].WFSim.activeWFScnt, AOconf[loop].DMctrl.activeDMcnt, 0.0);

            if (sprintf(name, "aol%ld_gainb", loop) < 1)
                {
                    PRINT_ERROR("sprintf wrote <1 char");
                }
            if (sprintf(fname, "conf/shmim.gainb.fits") < 1)
                {
                    PRINT_ERROR("sprintf wrote <1 char");
                }
            aoloopcontrol_var.aoconfID_gainb = AOloopControl_IOtools_2Dloadcreate_shmim(
                name, fname, AOconf[loop].AOpmodecoeffs.DMmodesNBblock, 1, 0.0);

            if (sprintf(name, "aol%ld_modeARPFgainAuto", loop) < 1)
                {
                    PRINT_ERROR("sprintf wrote <1 char");
                }
            if (sprintf(fname, "conf/shmim.modeARPFgainAuto.fits") < 1)
                {
                    PRINT_ERROR("sprintf wrote <1 char");
                }
            aoloopcontrol_var.aoconfID_modeARPFgainAuto =
                AOloopControl_IOtools_2Dloadcreate_shmim(name, fname, AOconf[loop].AOpmodecoeffs.NBDMmodes, 1, 1.0);

            if (sprintf(name, "aol%ld_multfb", loop) < 1)
                {
                    PRINT_ERROR("sprintf wrote <1 char");
                }
            if (sprintf(fname, "conf/shmim.multfb.fits") < 1)
                {
                    PRINT_ERROR("sprintf wrote <1 char");
                }
            aoloopcontrol_var.aoconfID_multfb = AOloopControl_IOtools_2Dloadcreate_shmim(
                name, fname, AOconf[loop].AOpmodecoeffs.DMmodesNBblock, 1, 0.0);
            ...
            if (sprintf(fname, "conf/shmim.limitb.fits") < 1)
                {
                    PRINT_ERROR("sprintf wrote <1 char");
                }
            aoloopcontrol_var.aoconfID_limitb = AOloopControl_IOtools_2Dloadcreate_shmim(
                name, fname, AOconf[loop].AOpmodecoeffs.DMmodesNBblock, 1, 0.0);
            ...
            for (kk = 0; kk < AOconf[loop].AOpmodecoeffs.DMmodesNBblock; kk++)
                {
                    ...
                    fflush(stdout);
                    if ((ID = AOloopControl_IOtools_3Dloadcreate_shmim(
                             name, fname, AOconf[loop].DMctrl.sizexDM, AOconf[loop].DMctrl.sizeyDM, 0, 0.0)) != -1)
                        {
                            AOconf[loop].AOpmodecoeffs.NBmodes_block[kk] = data.image[ID].md[0].size[2];
                        }

                    for (unsigned int m = mstart; m < (mstart + AOconf[loop].AOpmodecoeffs.NBmodes_block[kk]); m++)
                        {
                    ...
                    printf("====== LOADING %s to %s\n", fname, name);
                    fflush(stdout);
                    AOloopControl_IOtools_3Dloadcreate_shmim(name,
                                                             fname,
                                                             AOconf[loop].WFSim.sizexWFS,
                                                             AOconf[loop].WFSim.sizeyWFS,
                                                             AOconf[loop].AOpmodecoeffs.NBmodes_block[kk],
                                                             0.0);
                    ...
                    ID = AOloopControl_IOtools_3Dloadcreate_shmim(name,
                                                                  fname,
                                                                  AOconf[loop].WFSim.sizexWFS,
                                                                  AOconf[loop].WFSim.sizeyWFS,
                                                                  AOconf[loop].DMctrl.sizexDM *
                    ...
                    for (unsigned long ii = 0; ii < AOconf[loop].WFSim.sizexWFS * AOconf[loop].WFSim.sizeyWFS *
                                                        AOconf[loop].DMctrl.sizexDM * AOconf[loop].DMctrl.sizeyDM;
                         ii++)
                        {
                            data.image[aoloopcontrol_var.aoconfID_contrMc].array.F[ii] +=
                    ...
                    printf("====== LOADING %s to %s  size %u %u\n",
                           ...
                           AOconf[loop].WFSim.activeWFScnt,
                           AOconf[loop].DMctrl.activeDMcnt);
                    ID = AOloopControl_IOtools_2Dloadcreate_shmim(
                        name, fname, AOconf[loop].WFSim.activeWFScnt, AOconf[loop].DMctrl.activeDMcnt, 0.0);

                    if (kk == 0)
                        {
                            for (unsigned long ii = 0;
                                 ii < AOconf[loop].WFSim.activeWFScnt * AOconf[loop].DMctrl.activeDMcnt;
                                 ii++)
                                {
                    ...
                    for (unsigned long ii = 0; ii < AOconf[loop].WFSim.activeWFScnt * AOconf[loop].DMctrl.activeDMcnt;
                         ii++)
                        {
                            data.image[aoloopcontrol_var.aoconfID_contrMcact[0]].array.F[ii] +=
                                data.image[aoloopcontrol_var.aoconfID_gainb].array.F[kk] * data.image[ID].array.F[ii];
                        }
                }
        }
    ...
    if (AOconf[loop].AOpmodecoeffs.DMmodesNBblock == 1)
    ...
    else
        {
            ...
            for (unsigned int k = 1; k < AOconf[loop].AOpmodecoeffs.DMmodesNBblock; k++)
                {
                    AOconf[loop].AOpmodecoeffs.indexmaxMB[k] =
                        AOconf[loop].AOpmodecoeffs.indexmaxMB[k - 1] + AOconf[loop].AOpmodecoeffs.NBmodes_block[k];
                }
        }
    ...
    for (unsigned int k = 1; k < AOconf[loop].AOpmodecoeffs.DMmodesNBblock; k++)
        {
            if (sprintf(fname, "./conf/param_blockoffset_%02d.txt", k) < 1)
                {
                    PRINT_ERROR("sprintf wrote <1 char");
                }
            fp = fopen(fname, "w");
