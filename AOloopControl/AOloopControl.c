...
errno_t AOloopControl_WFSzeropoint_sum_update_loop_cli()
{
    if (DISABLE_CLI_AOloopControl + CLI_checkarg(1, CLIARG_STR_NOT_IMG) + CLI_checkarg(2, CLIARG_LONG) +
        ...
        0)
        {
            AOloopControl_WFSzeropoint_sum_update_loop(LOOPNUMBER,
    ...
    if (DISABLE_CLI_AOloopControl + CLI_checkarg(1, CLIARG_LONG) + CLI_checkarg(2, CLIARG_FLOAT) +
        ...
        0)
        {
            AOloopControl_set_modeblock_gain(
                LOOPNUMBER, data.cmdargtoken[1].val.numl, data.cmdargtoken[2].val.numf, data.cmdargtoken[3].val.numl);
            return CLICMD_SUCCESS;
        }
    else
        {
    ...
    if (DISABLE_CLI_AOloopControl + CLI_checkarg(1, CLIARG_LONG) + CLI_checkarg(2, CLIARG_LONG) +
        ...
        0)
        {
            AOloopControl_setgainrange(
                data.cmdargtoken[1].val.numl, data.cmdargtoken[2].val.numl, data.cmdargtoken[3].val.numf);
            return CLICMD_SUCCESS;
        }
    else
        {
...
static errno_t init_module_CLI()
{
    ...
    CORE_logFunctionCall(
        AOLOOPCONTROL_logfunc_level, AOLOOPCONTROL_logfunc_level_max, 0, __FILE__, __FUNCTION__, __LINE__, "");
#endif
   ...
   */
    ...
    RegisterCLIcommand("aolzpwfsloop",
                       __FILE__,
    ...
    RegisterCLIcommand("aolzpwfscloop",
                       __FILE__,
    ...
    RegisterCLIcommand("aolmc2dmfilt",
                       __FILE__,
    ...
    RegisterCLIcommand("aolsig2mcoeff",
                       __FILE__,
    ...
    RegisterCLIcommand(
        "aolon", __FILE__, AOloopControl_loopon, "turn loop on", "no arg", "aolon", "int AOloopControl_loopon()");

    RegisterCLIcommand(
        "aoloff", __FILE__, AOloopControl_loopoff, "turn loop off", "no arg", "aoloff", "int AOloopControl_loopoff()");
   ...
   */
    ...
    RegisterCLIcommand("aollogprocmodeval",
                       __FILE__,
    ...
    RegisterCLIcommand("aolsetgainr",
                       __FILE__,
    ...
    RegisterCLIcommand("aolsetlimitr",
                       __FILE__,
    ...
    RegisterCLIcommand("aolsetmultfr",
                       __FILE__,
    ...
    RegisterCLIcommand("aolsetgainb",
                       __FILE__,
    ...
    RegisterCLIcommand("aolsetlimitb",
                       __FILE__,
    ...
    RegisterCLIcommand("aolsetmultfb",
                       __FILE__,
    ...
    RegisterCLIcommand("aolscangainb",
                       __FILE__,
    ...
    RegisterCLIcommand("aoldm2dmoffload",
                       __FILE__,
   ...
   */
    ...
    RegisterCLIcommand("aolrtlogsavel",
                       __FILE__,
    ...
    RegisterCLIcommand("aolrtlogsetsaveON",
                       __FILE__,
    ...
    RegisterCLIcommand("aolrtlogsetsaveOFF",
                       __FILE__,
    ...
    RegisterCLIcommand("aolrtlogsetON",
                       __FILE__,
    ...
    RegisterCLIcommand("aolrtlogsetOFF",
                       __FILE__,
