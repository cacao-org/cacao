...
# input WFS stream
export CACAO_WFSSTREAM="kcam"    # Hardware stream, connected to physical camera
export CACAO_WFSSTREAMSIM="kcamsim" # Simulation camera stream
...
#
# assumed to be already deployed
