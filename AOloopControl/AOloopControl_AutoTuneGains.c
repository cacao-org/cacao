    ...
    for (;;)
        {
            ...
            while (kk < NBgain)
                {
                    ...
                    // gainval1_array[kk], gainval2_array[kk]);
                    gain *= gainfactstep;
                    kk++;
                }
                    ...
                    if (TESTMODE == 1)
                        {
                            fprintf(fptest,
                                    ...
                                    cnt,
                                    data.image[IDmodeval].array.F[TEST_m],
                                    data.image[IDmodevalOL].array.F[TEST_m],
            ...
            printf("[%8ld]  %8ld   %8.6f -> %8.6f\n",
                   ...
                   AOconf[loop].AOAutoTune.AUTOTUNEGAINS_updateGainCoeff,
                   GainCoeff1);
