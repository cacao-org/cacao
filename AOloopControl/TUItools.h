...
#else
static inline errno_t TUI_ncurses_refresh()
{
    return 0;
}
static inline errno_t TUI_ncurses_erase()
{
    return 0;
}
static inline errno_t TUI_get_terminal_size(short unsigned int *wrowptr,
