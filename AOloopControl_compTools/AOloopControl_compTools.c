...
static errno_t init_module_CLI()
{
   ...
   */
    ...
    RegisterCLIcommand("aolcrossp",
                       ...
                       "compute cross product between two cubes. Apply mask if "
                       "image xpmask exists",
                       "<cube1> <cube2> <output image>",
                       "aolcrossp imc0 imc1 crosspout",
                       "AOloopControl_compTools_CrossProduct(char *ID1_name, "
                       "char *ID1_name, char *IDout_name)");

    RegisterCLIcommand("aolmksimplezpM",
                       __FILE__,
                       ...
                       "long AOloopControl_compTools_mkSimpleZpokeM( long "
                       "dmxsize, long dmysize, char *IDout_name)");
